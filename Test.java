...
public class Test {
    public static void main(String[] args) {
        ...
        while (flag == 1) {
            ...
            try {
            Course a = s;  
            Student w = new Student(2019311319, "夏驰峰", '男',a);
            System.out.println("学生信息");
            System.out.println(w);
            Teacher b = new Teacher(1, "张", '男', "java");
            Teacher c = new Teacher(2, "游", '男', "线代");
            Teacher d = new Teacher(3, "魏", '女', "离散");
            System.out.println("教师信息");
            System.out.println(b);
            System.out.println(c);
            System.out.println(d);
            Course e = new Course("java", 1, "300", 2, 2);
            Course f = new Course("线代", 2, "202", 2, 2);
            Course g = new Course("离散", 3, "300", 2, 4);
            ...
            Student n = new Student(2019311319, "夏驰峰", '男',a);
            ...
            Student o = new Student(2019311319, "夏驰峰", '男',a);
